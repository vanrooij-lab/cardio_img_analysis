...
my_work_dir = '/Volumes/Wehrens_Mic/IMG_ANALYSIS/2023-03-15_MW-PC-epi-titrate/'
...
for S_IDX in range(len(my_samples)):
    ...
    current_second_peak = peaks_in_mytrace_pos[1]
    ...
    plt.plot(current_second_peak, current_trace_1min[current_firstpeak],'ko')    
